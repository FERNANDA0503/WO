...
<head>
    ...
    <!-- Modernizr JS -->
    <script src="{{ URL::asset("/User/js/modernizr-2.6.2.min.js") }}"></script>
    <!-- FOR IE9 below -->
    <!--[if lt IE 9]>
...
<body>
    ...
    <div id="page">
        ...
        <header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(/User/images/img_bg_2.jpg);"
            ...
            <div class="container">
                ...
                <div class="couple-wrap animate-box">
                    <div class="couple-half">
                        <div class="groom">
                            <img src="{{ URL::asset("/User/images/groom.jpg") }}" alt="groom" class="img-responsive">
                        </div>
                    ...
                    <div class="couple-half">
                        <div class="bride">
                            <img src="{{ URL::asset("/User/images/bride.jpg") }}" alt="groom" class="img-responsive">
                        </div>
        ...
        <div id="fh5co-event" class="fh5co-bg" style="background-image:url(/User/images/img_bg_3.jpg);">
            <div class="overlay"></div>
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
                    ...
                    <div class="col-md-12 col-md-offset-0">
                        <ul class="timeline animate-box">
                            <li class="animate-box">
                                <div class="timeline-badge" style="background-image:url(/User/images/couple-1.jpg);"></div>
                            ...
                            <li class="timeline-inverted animate-box">
                                <div class="timeline-badge" style="background-image:url(/User/images/couple-2.jpg);"></div>
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                            ...
                            <li class="animate-box">
                                <div class="timeline-badge" style="background-image:url({{ URL::asset("/User/images/couple-3.jpg") }});"></div>
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                    ...
                    <div class="col-md-12">
                        <ul id="fh5co-gallery-list">
                            ...
                            <li class="one-third animate-box" data-animate-effect="fadeIn"
                                ...
                                <a href="{{ URL::asset("/Userimages/gallery-1.jpg") }}">
                                ...
                                <div class="owl-carousel-fullwidth">
                                    <div class="item">
                                        <div class="testimony-slide active text-center">
                                            <figure>
                                                <img src="{{ URL::asset("/User/images/couple-1.jpg") }}" alt="user">
                                            </figure>
                                    ...
                                    <div class="item">
                                        <div class="testimony-slide active text-center">
                                            <figure>
                                                <img src="{{ URL::asset("/User/images/couple-2.jpg") }}" alt="user">
                                            </figure>
                                            <span>John Doe, via <a href="#" class="twitter">Twitter</a></span>
                                            <blockquote>
                                                <p>"Far far away, behind the word mountains, far from the countries
                                    ...
                                    <div class="item">
                                        <div class="testimony-slide active text-center">
                                            <figure>
                                                <img src="{{ URL::asset("/User/images/couple-3.jpg") }}" alt="user">
                                            </figure>
                                            <span>John Doe, via <a href="#" class="twitter">Twitter</a></span>
                                            <blockquote>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 animate-box">
                        <div class="fh5co-video fh5co-bg" style="background-image: url(/User/images/img_bg_3.jpg); ">
    ...
    <!-- countTo -->
    <script src="{{ URL::asset("/User/js/jquery.countTo.js") }}"></script>
    ...
    <script src="{{ URL::asset("/User/js/magnific-popup-options.js") }}"></script>

    <!-- // <script src="https://cdnjs.cloudflare.com/ajax/libs/prism/0.0.1/prism.min.js"></script> -->
    <script src="{{ URL::asset("/User/js/simplyCountdown.js") }}"></script>
    <!-- Main -->
